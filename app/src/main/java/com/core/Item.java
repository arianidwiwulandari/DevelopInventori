...
public class Item implements Serializable {
    ...
    public static final String TABLE_CREATE =
        "create table if not exists Inventory (_id integer primary key autoincrement , stock_id text not null, sale_id integer, description_id integer not null, inventorylineitem_id integer not null , cost real not null);";
    ...
    public static final String COL_STOCK = "stock_id";
	...
	public Item(int id,ItemDescription itemDescription , String stock) {
	...
	public Item(int id,ItemDescription itemDescription , float cost , String stock) {
		this.itemDesciption = itemDescription;
		this.id= id;
		this.cost = cost;
		this.setStock(stock);
